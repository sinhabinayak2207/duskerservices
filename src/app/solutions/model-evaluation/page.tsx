      ...
      <section className={styles.testimonials}>
        <div className={styles.container}>
          ...
          >
            ...
            <motion.p className={styles.sectionDescription} variants={fadeIn}>
              See how our evaluation solutions have helped organizations build better AI models.
            </motion.p>
            ...
            <motion.div 
              ...
              variants={staggerContainer}
            >
              <motion.div className={styles.testimonialCard} variants={fadeIn}>
                <p className={styles.testimonialQuote}>
                  Dusker's model evaluation platform helped us identify critical performance gaps in our recommendation system that we hadn't caught with our internal testing. The insights led to a 24% improvement in user engagement.
                </p>
                <div className={styles.testimonialAuthor}>
                  ...
                  <div className={styles.testimonialInfo}>
                    <h4>James Wilson</h4>
                    <p>Chief AI Officer, StreamFlix</p>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div className={styles.testimonialCard} variants={fadeIn}>
                <p className={styles.testimonialQuote}>
                  The fairness evaluation tools from Dusker were instrumental in helping us identify and mitigate bias in our hiring algorithms. We now have a much more equitable system and better regulatory compliance.
                </p>
                <div className={styles.testimonialAuthor}>
                  <img 
                  ...
                  <div className={styles.testimonialInfo}>
                    ...
                    <p>VP of HR Technology, Global Talent Inc.</p>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div className={styles.testimonialCard} variants={fadeIn}>
                <p className={styles.testimonialQuote}>
                  As a healthcare AI company, we needed rigorous evaluation that considered both technical performance and patient safety. Dusker's comprehensive approach gave us confidence in our models and helped with FDA approval.
                </p>
                <div className={styles.testimonialAuthor}>
                  <img 
