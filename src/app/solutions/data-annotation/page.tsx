      ...
      <section className={styles.testimonials}>
        <div className={styles.container}>
          ...
          >
            ...
            <motion.p className={styles.sectionDescription} variants={fadeIn}>
              See how our annotation solutions have helped organizations achieve their AI goals.
            </motion.p>
            ...
            >
              <motion.div className={styles.testimonialCard} variants={fadeIn}>
                <p className={styles.testimonialQuote}>
                  Dusker's data annotation service has been instrumental in helping us build our computer vision models. Their attention to detail and quality control processes have significantly improved our model performance.
                </p>
                <div className={styles.testimonialAuthor}>
                  ...
                  <div className={styles.testimonialInfo}>
                    <h4>Sarah Johnson</h4>
                    <p>AI Research Lead, TechVision Inc.</p>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div className={styles.testimonialCard} variants={fadeIn}>
                <p className={styles.testimonialQuote}>
                  The speed and accuracy of Dusker's annotation platform allowed us to scale our medical imaging AI project much faster than expected. Their specialized healthcare annotation team truly understands our requirements.
                </p>
                <div className={styles.testimonialAuthor}>
                  <img 
              ...
              <motion.div className={styles.testimonialCard} variants={fadeIn}>
                <p className={styles.testimonialQuote}>
                  We've tried several annotation services, but Dusker stands out with their hybrid AI-human approach. It's given us both the quality we need and the scale to handle our massive dataset requirements.
                </p>
                <div className={styles.testimonialAuthor}>
                  <img 
                  ...
                  <div className={styles.testimonialInfo}>
                    <h4>Priya Sharma</h4>
                    <p>Data Science Director, Global Retail Group</p>
                  </div>
                </div>
              </motion.div>
            </motion.div>
