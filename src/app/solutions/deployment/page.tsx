      ...
      <section className={styles.testimonials}>
        <div className={styles.container}>
          ...
          >
            ...
            <motion.p className={styles.sectionDescription} variants={fadeIn}>
              See how our deployment solutions have helped organizations operationalize AI at scale.
            </motion.p>
            ...
            >
              <motion.div className={styles.testimonialCard} variants={fadeIn}>
                <p className={styles.testimonialQuote}>
                  Dusker's deployment platform reduced our time-to-production from weeks to hours. The automated scaling has been a game-changer for handling our variable traffic patterns while keeping costs under control.
                </p>
              ...
              <motion.div className={styles.testimonialCard} variants={fadeIn}>
                <p className={styles.testimonialQuote}>
                  As a healthcare company with strict regulatory requirements, we needed a deployment solution that could meet our security and compliance needs. Dusker's on-premises deployment option was perfect for us.
                </p>
                <div className={styles.testimonialAuthor}>
                  <img 
                  ...
                  <div className={styles.testimonialInfo}>
                    ...
                    <p>Head of AI, MedTech Solutions</p>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div className={styles.testimonialCard} variants={fadeIn}>
                <p className={styles.testimonialQuote}>
                  We deployed over 50 models across our global retail operations using Dusker's platform. The monitoring capabilities have been invaluable in identifying performance issues before they impact our customers.
                </p>
                <div className={styles.testimonialAuthor}>
                  <img 
                  ...
                  <div className={styles.testimonialInfo}>
                    <h4>Marcus Chen</h4>
                    <p>VP of Data Science, Global Retail Group</p>
                  </div>
                </div>
              </motion.div>
            </motion.div>
